...
request.onupgradeneeded = function(event) {
    ...
    // create object store (table) called `new_pizza`, set it to have auto incrementing primary key of sorts
...
// the function will be executed if we attempt to submit a new pizza and there is no internet connection
function saveRecord(record) {
    // open new transaction with db with read & write perms
...
function uploadPizza() {
    ...
    getAll.onsuccess = function() {
        // if data in indexedDb's store then send to api server
